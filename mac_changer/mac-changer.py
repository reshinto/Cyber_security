...
subprocess.call([ip_command, interface, "down"])  # all commands run after index 0 is a subcommand
print(f"{interface} has been disabled")
# change ethernet_interface's mac address
subprocess.call([ip_command, interface, "hw", "ether", new_mac])
print(f"mac address has been changed to {new_mac}")
# enable ethernet_interface
subprocess.call([ip_command, interface, "up"])
